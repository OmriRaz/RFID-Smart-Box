...
byte buffer[10];
char string1[] = " MAKERCPACE         "; //contents of first print
char string2[] = " USER 1 "; //contents of second print
char string3[] = " USER 2 ";
char string4[] = " USER 3 ";
char string5[] = " ADMIN ";
...
/* pirval = digitalRead(pir);
 if(pirval == HIGH) {
  ...
  content.toUpperCase();
  if (content.substring(1) == "BD 31 15 2B") {// FIRST ID OF RFID CHIP
    printStringWithShift(string1, 100);  
    Serial.println("Authorized access: USER 1");
    Serial.println();
   
  }

  if (content.substring(1) == "0E 03 CF 21 ") { //SECOND ID OF RFID CHIP
  ...
  if (content.substring(1) == "53 82 5E CF") {
    printStringWithShift(string3, 100);  
    Serial.println("Authorized access: USER 2");
    Serial.println();
  }

  if (content.substring(1) == "BD 31 15 2B") {// THIRD ID OF RFID CHIP
    printStringWithShift(string4, 100);  
    Serial.println("Authorized access: USER 3");
    Serial.println();
